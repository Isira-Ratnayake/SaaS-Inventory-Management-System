...
export default function GoodsReturnNotes() {
  return (
    <>
      <SideNavigation index="5" />

      {/* Dashboard */}
      <div className="container">
        <div className="main-content">
          <div className="header">
            <h1>Goods Return Notes Management</h1>
          </div>
            ...
            <div className="modal-header align-items-start">
              <div>
                <h4 className="page-header fs-5">
                  Goods Return Notes Management | View
                </h4>
              </div>
              <button
                type="button"
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header align-items-start">
              <div>
                <h4 className="page-header fs-5">
                  Goods Return Notes Management | Delete
                </h4>
              </div>
              <button
                type="button"
      ...
      >
        <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header align-items-start">
              <div>
                <h4 className="page-header">Add GRRN</h4>
              </div>
              <button
                type="button"
                className="btn-close"
            ...
            <div className="modal-body">
              ...
              <div className="col text-end add-btn pe-2">
                <button
                  ...
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#addItemToGRRNModal"
                >
                  &nbsp;<i className="fa-sharp fa-solid fa-circle-plus"></i>
                  &nbsp;&nbsp;Add&nbsp;Item&nbsp;to&nbsp;GRRN&nbsp;
                </button>
              ...
              <div className="row align-items-center justify-content-between my-5">
                <div className="col">Total Cost Returned</div>
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header align-items-start">
              <div>
                <h4 className="page-header fs-5">
                  Goods Return Notes Management | Edit
                </h4>
              </div>
              <button
                type="button"
      ...
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header align-items-start">
              <div>
                <h4 className="page-header">Add Item to GRRN</h4>
              </div>
              <button
                type="button"
                className="btn-close"
