        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header align-items-start">
              <div>
                <h4 className="page-header fs-5">Invoices Management | View</h4>
              </div>
              <button
                type="button"
                className="btn-close"
              ...
              <table className="table table-hover">
                <tbody className="modal-table-body">
                  ...
                  <tr>
                    ...
                    <td className="text-truncate align-middle">12-03-2023</td>
                  </tr>
                  <tr>
                    <th scope="row">
                      <div className="row table-heading align-items-center">
                    ...
                    <td className="text-truncate align-middle">ABCD</td>
                  </tr>
                  <tr>
                    <th scope="row">
                      <div className="row table-heading align-items-center">
                    ...
                    <td className="text-truncate align-middle">Complete</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      >
        <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header align-items-start">
              <div>
                <h4 className="page-header">Add Invoice</h4>
              </div>
              <button
                type="button"
                className="btn-close"
            ...
            <div className="modal-body">
              ...
              <div className="col text-end add-btn pe-2">
                <button
                  ...
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#addItemToInvoice"
                >
                  &nbsp;<i className="fa-sharp fa-solid fa-circle-plus"></i>
                  &nbsp;&nbsp;Add&nbsp;Item&nbsp;to&nbsp;Invoice
                </button>
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header align-items-start">
              <div>
                <h4 className="page-header fs-5">Invoices Management | Edit</h4>
              </div>
              <button
                type="button"
                className="btn-close"
      ...
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header align-items-start">
              <div>
                <h4 className="page-header">Add Customer</h4>
              </div>
              <button
                type="button"
                className="btn-close"
      ...
      >
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header align-items-start">
              <div>
                <h4 className="page-header">Add Item to Invoice</h4>
              </div>
              <button
                type="button"
                className="btn-close"
